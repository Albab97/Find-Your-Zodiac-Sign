$(function(){
    $('.zodiacBtn.aries').on('click',function(){
      $('#imageZ').empty()
      $('#imageZ').append(`<img src="media/aries_logo.jpg" alt="image" height="200px" width="200px">`)
      $(".card-title").text("Aries")
      $('.engName').text('The Ram')
      $('.planet').text('Mars')
      $('.abcde').text('People of Aries sign are open-hearted and strong. Their main features are frankness and honesty. Aries sign loves work. Aries sign is true and fair in love. Aries sign is seldom ill. Aries woman is intellectual and extremely strong. Aries man is overflown with ideas and creative energy.')
    })
    $('.zodiacBtn.taurus').on('click',function(){
        $('#imageZ').empty()
        $('#imageZ').append(`<img src="media/taurus_logo.jpg" alt="image" height="200px" width="200px">`)
    ...
    $('.zodiacBtn.gemini').on('click',function(){
      $('#imageZ').empty()
      $('#imageZ').append(`<img src="media/gemini_logo.jpg" alt="image" height="200px" width="200px">`)
    ...
    $('.zodiacBtn.cancer').on('click',function(){
      $('#imageZ').empty()
      $('#imageZ').append(`<img src="media/cancer_logo.jpg" alt="image" height="200px" width="200px">`)
    ...
    $('.zodiacBtn.leo').on('click',function(){
      $('#imageZ').empty()
      $('#imageZ').append(`<img src="media/leo_logo.jpg" alt="image" height="200px" width="200px">`)
      $(".card-title").text("Leo")
    ...
    $('.zodiacBtn.virgo').on('click',function(){
      $('#imageZ').empty()
      $('#imageZ').append(`<img src="media/virgo_logo.jpg" alt="image" height="200px" width="200px">`)
    ...
    $('.zodiacBtn.libra').on('click',function(){
      $('#imageZ').empty()
      $('#imageZ').append(`<img src="media/libra_logo.png" alt="image" height="200px" width="200px">`)
    ...
    $('.zodiacBtn.scorpio').on('click',function(){
      $('#imageZ').empty()
      $('#imageZ').append(`<img src="media/scorpio_logo.jpg" alt="image" height="200px" width="200px">`)
    ...
    $('.zodiacBtn.sagittarius').on('click',function(){
      $('#imageZ').empty()
      $('#imageZ').append(`<img src="media/sagittarius_logo.jpg" alt="image" height="200px" width="200px">`)
    ...
    $('.zodiacBtn.capricorn').on('click',function(){
      $('#imageZ').empty()
      $('#imageZ').append(`<img src="media/capricorn_logo.png" alt="image" height="200px" width="200px">`)
    ...
    $('.zodiacBtn.aquarius').on('click',function(){
      $('#imageZ').empty()
      $('#imageZ').append(`<img src="media/aquarius_logo.jpg" alt="image" height="200px" width="200px">`)
      $(".card-title").text("Aquarius")
      $('.engName').text('The Water Carrier')
      $('.planet').text('Uranus')
      $('.abcde').text('Aquarius-born are shy and quiet , but on the other hand they can be eccentric and energetic. However, in both cases, they are deep thinkers and highly intellectual people who love helping others. They are able to see without prejudice, on both sides, which makes them people who can easily solve problems.')
    })
    $('.zodiacBtn.pisces').on('click',function(){
      $('#imageZ').empty()
      $('#imageZ').append(`<img src="media/pisces_logo.jpg" alt="image" height="200px" width="200px">`)
